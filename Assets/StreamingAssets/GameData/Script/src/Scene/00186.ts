...
EventModifyPos(186, 71, 16, 6);
EventModifyPos(186, 71, 16, 7);
EventModifyPos(186, 71, 16, 8);
EventModifyPos(186, 71, 16, 9);
EventModifyPos(186, 71, 16, 10);
EventModifyPos(186, 71, 16, 11);
EventModifyPos(186, 71, 16, 12);

['Event_00186_00073_Trigger'];
EventSetState(-1, 0, 0);
EventSetState(3117, 1, 0);
PlaySound(71);
...
Dos_SetBattlefield(FbpDos.蛤蟆洞_1);
...
BattleEnd();
PartySetPos(10, 17, 0);
EventSetAutoScript(186, 74, "@664D");
WaitEventAutoScriptRun(6, false, false);
RoleSetDirFrame(0, 0, 0);
WaitEventAutoScriptRun(14, false, false);
EventSetState(3117, 0, 0);
WaitEventAutoScriptRun(4, false, false);
SetDlgLower(1, 0, false);
//李逍遥：
//对不起啦！　凤凰妈妈
//借您生的蛋一用
EventSetState(3114, 1, 0);
...
RoleMoveOneStep(0, 8, 0);
WaitEventAutoScriptRun(0, false, false);
EventSetAutoScript(186, 71, "@66CA");
RoleMoveOneStep(0, 8, 0);
WaitEventAutoScriptRun(0, false, false);
...
//阿奴：
//想得美咧～才不要给你！
EventSetDirFrame(186, 71, 0, 10);
WaitEventAutoScriptRun(4, false, false);
SetDlgUpper(10, 0, false);
//李逍遥：
//你．．你想做什么？
EventSetDirFrame(186, 71, 0, 15);
WaitEventAutoScriptRun(3, false, false);
EventSetDirFrame(186, 71, 0, 16);
WaitEventAutoScriptRun(0, false, false);
PartyWalkToBlock(7, 30, 0, 4);
//李逍遥：
//喂～别做傻事啊！
PartyWalkToBlock(8, 31, 0, 4);
EventSetAutoScript(186, 71, "@66E0");
EventSetAutoScript(186, 72, "Event_00186_00072_Auto");
EventSetLayer(186, 71, 10);
HeroSetSprite(0, Sprite.空空如也, true);
RoleSetDirFrame(0, 0, 0);
EventSetState(3118, 1, 0);
ViewportMove(2, 0, 5);
...
FadeOut(0);
EventSetState(3119, 1, 0);
EventSetState(3120, 1, 0);
EventSetState(3121, 1, 0);
EventSetState(3122, 1, 0);
